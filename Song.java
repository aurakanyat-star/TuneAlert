...
public final class Song {
    ...
    /**
     * @param title ห้าม null และ ว่าง
     * @param artist ห้าม null และ ว่าง
     * @param tags ห้าม null และห้ามมีสมาชิกเป็น null/ว่าง
     * @throws IllegalArgumentException เมื่อผิดเงื่อนไข
     */
    ...
    public Song(String title, String artist, List<String> tags) {
        ...
        if (title == null || title.isEmpty()) throw new IllegalArgumentException("Title is null/empty");
        if (artist == null || artist.isEmpty()) throw new IllegalArgumentException("Artist is null/empty");
        if (tags == null || tags.contains(null) || tags.contains("")) throw new IllegalArgumentException("Tags proplem");
        this.title = title;
        this.artist = artist;
    ...
    private void checkRep(){
        assert title != null && title!="" : "title ต้องไม่เป็น null และ ว่าง";
        assert artist != null && artist!="" : "artist ต้องไม่เป็น null และ ว่าง";
        assert tags != null && !tags.contains(null) && !tags.contains("") : "tags ห้าม null และห้ามมีสมาชิกเป็น null/ว่าง";
